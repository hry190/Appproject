...
const Fig = {
  ...
  phoneInput: { left: 59, top: 387, w: 294, h: 40 },
  codeInput: { left: 59, top: 438, w: 294, h: 40 },
  newPwdInput: { left: 59, top: 490, w: 294, h: 40 },
  confirmInput: { left: 59, top: 540, w: 294, h: 40 },

  agreement: { left: 90, top: 590 },
  button: { left: 55, top: 616, w: 302, h: 45 },
} as const;
