...
_USER_FIELD_BY_TABLE = {
    ...
    "creation_intents": "owner_user_id",
    "creation_versions": "created_by_user_id",
    "image_generation_jobs": "owner_user_id",
    "creation_export_jobs": "owner_user_id",
    "publications": "owner_user_id",
    "classrooms": "owner_teacher_user_id",
    "classroom_memberships": "student_user_id",
    "publication_deliveries": "recipient_user_id",
