 ...
 *   - 图2(image 388.png,X=18, Y=478, W=355, H=321)— 中下部
 *
 * 坐标说明:
 ...
 *   - 图1:设计稿 image 387.png(已复制为 res/drawable-nodpi/img_volume5part3_image_387.png)
 *   - 图2:设计稿 image 388.png(已复制为 res/drawable-nodpi/img_volume5part3_image_388.png)
 */
@Composable
fun Volume5Part3Screen(
    onBack: () -> Unit = {},
    onOpenVolume5Part4: () -> Unit = {},
) {
    ...
    Box(
        ...
        Box(
            ...
            // 标题"样本从何而来"(字号 24,bold,黑色,X=110, Y=67, W=192, H=32)— 与 Vol-5-1/5-2 同款,点击跳第五卷-4。
            Text(
                text = "样本从何而来",
                color = Color.Black,
                fontSize = 24.sp,
                ...
                modifier = Modifier
                    ...
                    .clickable(onClick = onOpenVolume5Part4),
            )

            // 图1(image 387.png,X=18, Y=135, W=355, H=337)— 在书框之上、上部。
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
                    .offset(x = 18.dp, y = 135.dp)
                    .size(width = 355.dp, height = 337.dp),
            ) {
                Image(
            ...
            // 图2(image 388.png,X=18, Y=478, W=355, H=321)— 在书框之上、中下部。
