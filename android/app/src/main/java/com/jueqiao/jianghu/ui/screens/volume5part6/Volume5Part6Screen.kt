 ...
 *   - 图2(image 394.png,X=18, Y=478, W=355, H=321)— 中下部
 *
 * 坐标说明:
 ...
 *   - 图1:设计稿 image 393.png(已复制为 res/drawable-nodpi/img_volume5part6_image_393.png)
 *   - 图2:设计稿 image 394.png(已复制为 res/drawable-nodpi/img_volume5part6_image_394.png)
 */
@Composable
fun Volume5Part6Screen(
    ...
    Box(
        ...
        Box(
            ...
            // 图2(image 394.png,X=18, Y=478, W=355, H=321)— 在书框之上、中下部。
