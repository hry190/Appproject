 ...
 *   - 书框图像(Group 255.png,X=0, Y=88, W=854, H=784)— **复用第一卷书框素材**(与 Vol-2-9/10 同款;交替模式:Vol-2-2/8/11/14 用 256,其他 Vol-2 用 255)
 ...
 *   - 图1:设计稿 image 299.png(已复制为 res/drawable-nodpi/img_volume2part12_image_299.png)
 *   - 图2:设计稿 image 300.png(已复制为 res/drawable-nodpi/img_volume2part12_image_300.png)
 */
@Composable
