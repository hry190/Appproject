...
private val USER_AGREEMENT_TEXT = """
    ...
    五、作品投稿与公开展示
    用户向大会投稿作品前，应确保作品不含本人或他人的真实姓名、学校等身份信息，不含电话、住址或其他联系方式；作品涉及真人肖像时，应已取得合法授权；作品使用或参考的素材应具有合法来源和相应使用权。

    仅保存到创作档案的作品保持私密，只有用户主动点击“确认投稿”才会进入大会审核。使用智能工具辅助完成的作品，将自动保留“AI 辅助”标识。只有审核通过的作品才会在大会作品页公开展示。用户点击“确认投稿”即表示遵守本条约定，无需在每次投稿时重复确认。

    六、未成年人使用
    应用会根据注册时选择的年龄段提供适龄内容、安全提示与内容审核，不设置监护人控制模式或教师管理入口。
