 ...
 *   - 图1:设计稿 image 0.png(已复制为 res/drawable-nodpi/img_volume4part14_image_0.png)
 *   - 图2:设计稿 image 379.png(已复制为 res/drawable-nodpi/img_volume4part14_image_379.png)
 */
@Composable
fun Volume4Part14Screen(
    ...
    Box(
        ...
        Box(
            ...
            // 图1(image 0.png,X=18, Y=135, W=355, H=342)— 在书框之上、上部。
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
                    .offset(x = 18.dp, y = 135.dp)
                    .size(width = 355.dp, height = 342.dp),
            ) {
                Image(
