 ...
 *   - 图1:设计稿 image 324.png(已复制为 res/drawable-nodpi/img_volume3part4_image_324.png)
 *   - 图2:设计稿 image 325.png(已复制为 res/drawable-nodpi/img_volume3part4_image_325.png)
 *   - 图3:设计稿 image 326.png(已复制为 res/drawable-nodpi/img_volume3part4_image_326.png)
 */
@Composable
        ...
        Box(
            ...
            Box(
                modifier = Modifier
                    ...
                    .size(width = 356.dp, height = 193.dp),
            ) {
                Image(
