 ...
 *   - 图1:设计稿 image 267.png(已复制为 res/drawable-nodpi/img_volume1part13_image_267.png)
 *   - 图2:设计稿 image 268.png(已复制为 res/drawable-nodpi/img_volume1part13_image_268.png)
 */
@Composable
fun Volume1Part13Screen(
    ...
    Box(
        ...
        Box(
            ...
            // 图1(image 267.png,X=20, Y=135, W=350, H=311)— 在书框之上、上半区域。
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
