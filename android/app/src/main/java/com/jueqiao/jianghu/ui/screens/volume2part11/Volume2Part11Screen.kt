 ...
 *   - 图1:设计稿 image 296.png(已复制为 res/drawable-nodpi/img_volume2part11_image_296.png)
 *   - 图2:设计稿 image 297.png(已复制为 res/drawable-nodpi/img_volume2part11_image_297.png)
 */
@Composable
fun Volume2Part11Screen(
    ...
    Box(
        ...
        Box(
            ...
            // 图1(image 296.png,X=18, Y=155, W=352, H=278)— 上部
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
                    .offset(x = 18.dp, y = 155.dp)
                    .size(width = 352.dp, height = 278.dp),
            ) {
                Image(
