 ...
 *   - 图2(image 376.png,X=18, Y=478, W=355, H=321)— 中部
 *
 * 坐标说明:
 ...
 *   - 图1:设计稿 image 375.png(已复制为 res/drawable-nodpi/img_volume4part12_image_375.png)
 *   - 图2:设计稿 image 376.png(已复制为 res/drawable-nodpi/img_volume4part12_image_376.png)
 */
@Composable
fun Volume4Part12Screen(
    onBack: () -> Unit = {},
    onOpenVolume4Part13: () -> Unit = {},
) {
    ...
    Box(
        ...
        Box(
            ...
            // 标题"路边则重算"(字号 24,bold,黑色,X=110, Y=67, W=192, H=32)— 新标题系列,点击跳第四卷-13。
            Text(
                text = "路边则重算",
                color = Color.Black,
                fontSize = 24.sp,
                ...
                modifier = Modifier
                    ...
                    .clickable(onClick = onOpenVolume4Part13),
            )
            ...
            // 图2(image 376.png,X=18, Y=478, W=355, H=321)— 在书框之上、中部。
