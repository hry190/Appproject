 ...
 *   - 图1:设计稿 image 276.png(已复制为 res/drawable-nodpi/img_volume2part3_image_276.png)
 *   - 图2:设计稿 image 277.png(已复制为 res/drawable-nodpi/img_volume2part3_image_277.png)
 */
@Composable
fun Volume2Part3Screen(
    ...
    Box(
        ...
        Box(
            ...
            // 图1(image 276.png,X=20, Y=135, W=356, H=320)— 在书框之上、上半区域。
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
