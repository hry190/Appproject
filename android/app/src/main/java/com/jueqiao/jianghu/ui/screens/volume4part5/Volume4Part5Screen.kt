 ...
 *   - 图1:设计稿 image 359.png(已复制为 res/drawable-nodpi/img_volume4part5_image_359.png)
 *   - 图2:设计稿 image 360.png(已复制为 res/drawable-nodpi/img_volume4part5_image_360.png)
 */
@Composable
fun Volume4Part5Screen(
    onBack: () -> Unit = {},
    onOpenVolume4Part6: () -> Unit = {},
) {
    ...
    Box(
        ...
        Box(
            ...
            // 标题"穷尽还是剪枝"(字号 24,bold,黑色,X=110, Y=67, W=192, H=32)— 与 Vol-4-3/4-4 同款,点击跳第四卷-6。
            Text(
                text = "穷尽还是剪枝",
                color = Color.Black,
                fontSize = 24.sp,
                ...
                modifier = Modifier
                    ...
                    .clickable(onClick = onOpenVolume4Part6),
            )

            // 图1(image 359.png,X=18, Y=135, W=355, H=327)— 在书框之上、上部。
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
