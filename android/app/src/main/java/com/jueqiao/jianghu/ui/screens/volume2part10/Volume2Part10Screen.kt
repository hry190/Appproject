 ...
 *   - 图1:设计稿 image 294.png(已复制为 res/drawable-nodpi/img_volume2part10_image_294.png)
 *   - 图2:设计稿 image 295.png(已复制为 res/drawable-nodpi/img_volume2part10_image_295.png)
 */
@Composable
        ...
        Box(
            ...
            Box(
                modifier = Modifier
                    ...
                    .size(width = 344.dp, height = 292.dp),
            ) {
                Image(
