 ...
 *   - 图1:设计稿 image 303.png(已复制为 res/drawable-nodpi/img_volume2part14_image_303.png)
 *   - 图2:设计稿 image 304.png(已复制为 res/drawable-nodpi/img_volume2part14_image_304.png)
 */
@Composable
fun Volume2Part14Screen(
    ...
    Box(
        ...
        Box(
            ...
            // 图1(image 303.png,X=18, Y=155, W=352, H=323)— 上部
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
                    .offset(x = 18.dp, y = 155.dp)
                    .size(width = 352.dp, height = 323.dp),
            ) {
                Image(
