 ...
 *   - 图1:设计稿 image 231.png(已复制为 res/drawable-nodpi/img_volume1part3_image_231.png)
 *   - 图2:设计稿 image 232.png(已复制为 res/drawable-nodpi/img_volume1part3_image_232.png)
 */
@Composable
fun Volume1Part3Screen(
    onBack: () -> Unit = {},
    onOpenVolume1Part4: () -> Unit = {},
) {
        ...
        Box(
            ...
            Box(
                modifier = Modifier
                    ...
                    .size(width = 353.dp, height = 267.dp),
            ) {
                Image(
            ...
            // 标题"规则与学习的区别"(字号 24,bold,黑色,X=110, Y=67, W=192, H=32)— 与第一卷同位置同样式,点击跳第一卷-4。
            Text(
                text = "规则与学习的区别",
                color = Color.Black,
                fontSize = 24.sp,
                ...
                modifier = Modifier
                    ...
                    .clickable(onClick = onOpenVolume1Part4),
            )
        }
    }
}