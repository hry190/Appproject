 ...
 *   - 图1:设计稿 image 240.png(已复制为 res/drawable-nodpi/img_volume1part6_image_240.png)
 *   - 图2:设计稿 Mask group.png(已复制为 res/drawable-nodpi/img_volume1part6_mask_group.png)
 */
@Composable
