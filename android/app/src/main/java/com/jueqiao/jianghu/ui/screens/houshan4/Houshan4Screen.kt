 ...
 * **整屏点击 / 返回键的导航已断开**(2026-09-18 §13,待重设)—— 原为"点击标签以外任意位置 → dolly 推进到后山5"。
 *
 * ══════════════════════════════════════════════════════════════════════════
...
data class Houshan4Actions(
    ...
    // ── 卷跳转:仅"本页 Y 最大标签"使用 ──
    val onOpenVolume3Part1: () -> Unit = {},  // 标签1 万象谱(本页 Y 最大,Y=570)→ 第三卷-1
                ...
                Box(
                    modifier = Modifier
                        ...
                        .clickable(
                            ...
                            interactionSource = remember { MutableInteractionSource() },
                            indication = null,
                            onClick = actions.onOpenVolume3Part1,   // 2026-09-18 §14 恢复跳转(其余标签仍待设置)
                        ),
                ) {
                    Image(
                ...
                Box(
                    modifier = Modifier
                        ...
                        .clickable(
                            ...
                            interactionSource = remember { MutableInteractionSource() },
                            indication = null,
                            onClick = actions.onOpenHoushan5,   // 2026-09-18 §15 跳到"该文本为 Y 最大标签"的页面
                        ),
                ) {
                    Image(
                        painter = painterResource(R.drawable.img_shilian_recovered_4),
