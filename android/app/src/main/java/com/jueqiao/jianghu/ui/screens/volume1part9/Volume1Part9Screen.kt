 ...
 *   - 图1:设计稿 image 250.png(已复制为 res/drawable-nodpi/img_volume1part9_image_250.png)
 *   - 图2:设计稿 p.png(已复制为 res/drawable-nodpi/img_volume1part9_p.png)
 */
@Composable
fun Volume1Part9Screen(
    ...
    Box(
        ...
        Box(
            ...
            // 图1(image 250.png,X=20, Y=135, W=359, H=292)— 在书框之上、上半区域。
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
