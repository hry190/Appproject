 ...
 *   - 图1:设计稿 image 285.png(已复制为 res/drawable-nodpi/img_volume2part6_image_285.png)
 */
@Composable
fun Volume2Part6Screen(
    ...
    Box(
        ...
        Box(
            ...
            // 图1(image 285.png,X=20, Y=125, W=352, H=228)— 在书框之上、上半区域。
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
                    .offset(x = 20.dp, y = 125.dp)
                    .size(width = 352.dp, height = 228.dp),
            ) {
                Image(
