 ...
 *   - 图2(image 370.png,X=18, Y=478, W=361, H=321)— 中部
 *
 * 坐标说明:
 ...
 *   - 图1:设计稿 image 368.png(已复制为 res/drawable-nodpi/img_volume4part9_image_368.png)
 *   - 图2:设计稿 image 370.png(已复制为 res/drawable-nodpi/img_volume4part9_image_370.png)
 */
@Composable
fun Volume4Part9Screen(
    ...
    Box(
        ...
        Box(
            ...
            // 图2(image 370.png,X=18, Y=478, W=361, H=321)— 在书框之上、中部。
            // Y=478+321=799,在书框 Y=88-872 范围内安全(余量 73dp)。
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
                    .offset(x = 18.dp, y = 478.dp)
                    .size(width = 361.dp, height = 347.dp),
            ) {
                Image(
