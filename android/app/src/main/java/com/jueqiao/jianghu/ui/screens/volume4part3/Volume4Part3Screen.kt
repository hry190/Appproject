 ...
 *   - 图2(image 356.png,X=18, Y=489, W=355, H=320)— 中部
 *
 * 坐标说明:
 ...
 *   - 图2 Y=489+320=809,在书框 Y=88-872 范围内安全(余量 63dp)
 *   - 代码后续真机上调过:图2 Y=399→489(见行内注释)
 *
 * 资源来源:
 *   - 背景:设计稿 image 129.png(复用第一卷 img_volume1_bg.png 资源)
 *   - 书框:设计稿 Group 255.png(复用第一卷 img_volume1_group_255.png 资源)
 *   - 图1:设计稿 image 355.png(已复制为 res/drawable-nodpi/img_volume4part3_image_355.png)
 *   - 图2:设计稿 image 356.png(已复制为 res/drawable-nodpi/img_volume4part3_image_356.png)
 */
@Composable
fun Volume4Part3Screen(
    ...
    Box(
        ...
        Box(
            ...
            // 图1(image 355.png,X=18, Y=135, W=350, H=307)— 在书框之上、上部。
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
                    .offset(x = 18.dp, y = 135.dp)
                    .size(width = 350.dp, height = 307.dp),
            ) {
                Image(
            ...
            // 图2(image 356.png,X=18, Y=489, W=355, H=320)— 在书框之上、中部。
            // Y=489+320=809,在书框 Y=88-872 范围内安全(余量 63dp)。
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
                    .offset(x = 18.dp, y = 489.dp)
