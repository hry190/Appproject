 ...
 *   - 图2(image 342.png,X=18, Y=471, W=371, H=340)— 中部
 *
 * 坐标说明:
...
fun Volume3Part12Screen(
    ...
    Box(
        ...
        Box(
            ...
            // 图2(image 342.png,X=18, Y=471, W=371, H=340)— 在书框之上、中部。
            // Y=471+340=811,在书框 Y=88-872 范围内安全(余量 61dp)。
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
                    .offset(x = 18.dp, y = 471.dp)
                    .size(width = 371.dp, height = 340.dp),
            ) {
                Image(
