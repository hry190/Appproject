 ...
 *   - 图1:设计稿 image 417.png(已复制为 res/drawable-nodpi/img_volume6part5_image_417.png)
 *   - 图2:设计稿 image 418.png(已复制为 res/drawable-nodpi/img_volume6part5_image_418.png)
 *
...
fun Volume6Part5Screen(
    ...
    Box(
        ...
        Box(
            ...
            // 图1(image 417.png,X=18, Y=135, W=355, H=327)— 在书框之上、上部。
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
