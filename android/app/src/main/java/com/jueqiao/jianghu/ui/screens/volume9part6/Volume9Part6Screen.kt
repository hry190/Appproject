 ...
 *   - 图1:设计稿 image 500.png(已复制为 res/drawable-nodpi/img_volume9part6_image_500.png)
 *   - 图2:设计稿 image 502.png(已复制为 res/drawable-nodpi/img_volume9part6_image_502.png)— **用户字面跳过 image 501(直接 500→502)**,可能 image 501 缺失或为笔误;沿用字面
 *
