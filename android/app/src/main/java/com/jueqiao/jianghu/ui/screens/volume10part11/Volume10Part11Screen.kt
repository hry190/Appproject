 ...
 *   - 图2(image 40.png,X=18, **Y=381**, W=355, H=198)— 中部(**Y=381 非常用 Y=478**,沿用 Vol-7-7/Vol-10-10 2 张图布局变体的中部 Y;**2 张图布局变体**与标准 2 张图布局不同)— (应用新规则:扁横图 ratio 1.789 自动 fit W=355 H=round(355/1.789)=198)
 *
 * 坐标说明:
 ...
 *   - 图1:D:\图\image 480.png(已复制为 res/drawable-nodpi/img_volume10part11_image_480.png)
 *   - 图2:D:\图\image 40.png(已复制为 res/drawable-nodpi/img_volume10part11_image_40.png)
 *
...
fun Volume10Part11Screen(
    ...
    Box(
        ...
        Box(
            ...
            // 图1(image 480.png,X=18, Y=135, W=355, H=204)— 在书框之上、上部(扁横图)。
            Box(
                modifier = Modifier
                    .align(Alignment.TopStart)
                ...
                Image(
                    painter = painterResource(R.drawable.img_volume10part11_image_480),
            ...
            // 图2(image 40.png,X=18, Y=381, W=355, H=198)— 在书框之上、中部(扁横图,2 张图布局变体)— Y=381 沿用 Vol-7-7/Vol-10-10。
            ...
            Box(
                ...
                Image(
                    painter = painterResource(R.drawable.img_volume10part11_image_40),
